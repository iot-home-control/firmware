...
public:
    ...
    void begin(node_base *node, const int vnode_id, const char relay_pin, const char led_pin=-1, const char button_pin=-1, const bool start_on=false, const bool invert_relay=false, const bool invert_led=false);
    void update();
